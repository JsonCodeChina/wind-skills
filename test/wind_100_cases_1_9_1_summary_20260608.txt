...
- 执行时间：2026/6/8 17:13:22
- 输入文件：`测试报错用例100句.md`
- 测试技能：`wind-mcp-skill-1.9.1`
- 技能目录：`C:\Users\jhuan.jerry\Desktop\AIMarketTest\.agents\skills\wind-mcp-skill-1.9.1`
- 总数：100
- 成功：100
- 成功但有限制：0
- 无结果：0
...
- 完整入参、每次调用 stdout/stderr 和解析结果见 `wind_100_cases_1_9_1_results_20260608.json`。
