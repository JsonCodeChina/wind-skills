...
const cases = [
  { server_type: 'stock_data', tool_name: 'search_stocks', params: { question: '筛选A股中的银行股', lang: 'zh-CN' } },
  ...
  { server_type: 'stock_data', tool_name: 'get_stock_basicinfo', params: { question: '600519.SH公司基本档案', lang: 'zh-CN' } },
  { server_type: 'stock_data', tool_name: 'get_stock_fundamentals', params: { question: '贵州茅台2024年ROE和净利润增速', lang: 'zh-CN' } },
  { server_type: 'stock_data', tool_name: 'get_stock_equity_holders', params: { question: '贵州茅台前十大股东', lang: 'zh-CN' } },
  { server_type: 'stock_data', tool_name: 'get_stock_events', params: { question: '宁德时代2024年分红事件', lang: 'zh-CN' } },
  { server_type: 'stock_data', tool_name: 'get_stock_technicals', params: { question: '贵州茅台近60日MACD走势', lang: 'zh-CN' } },
  { server_type: 'stock_data', tool_name: 'get_risk_metrics', params: { question: '贵州茅台过去1年Beta和波动率', lang: 'zh-CN' } },

  { server_type: 'fund_data', tool_name: 'search_funds', params: { question: '筛选股票型基金', lang: 'zh-CN' } },
  ...
  { server_type: 'fund_data', tool_name: 'get_fund_info', params: { question: '易方达蓝筹精选005827.OF基金档案', lang: 'zh-CN' } },
  { server_type: 'fund_data', tool_name: 'get_fund_financials', params: { question: '005827.OF2024年净利润和分红', lang: 'zh-CN' } },
  { server_type: 'fund_data', tool_name: 'get_fund_holdings', params: { question: '005827.OF最新一期重仓股', lang: 'zh-CN' } },
  { server_type: 'fund_data', tool_name: 'get_fund_performance', params: { question: '005827.OF近1年业绩排名', lang: 'zh-CN' } },
  { server_type: 'fund_data', tool_name: 'get_fund_holders', params: { question: '005827.OF持有人结构', lang: 'zh-CN' } },
  { server_type: 'fund_data', tool_name: 'get_fund_company_info', params: { question: '易方达基金管理公司档案', lang: 'zh-CN' } },
  ...
  { server_type: 'index_data', tool_name: 'get_index_basicinfo', params: { question: '沪深300指数档案', lang: 'zh-CN' } },
  { server_type: 'index_data', tool_name: 'get_index_fundamentals', params: { question: '沪深300PE和PB历史分位', lang: 'zh-CN' } },
  { server_type: 'index_data', tool_name: 'get_index_technicals', params: { question: '沪深300的MACD和RSI', lang: 'zh-CN' } },

  { server_type: 'bond_data', tool_name: 'get_bond_basicinfo', params: { question: '国债2601基本信息', lang: 'zh-CN' } },
  { server_type: 'bond_data', tool_name: 'get_bond_issuer_info', params: { question: '国债2601发债主体', lang: 'zh-CN' } },
  { server_type: 'bond_data', tool_name: 'get_bond_market_data', params: { question: '国债2601久期和凸性', lang: 'zh-CN' } },
  { server_type: 'bond_data', tool_name: 'get_bond_financial_data', params: { question: '国债2601主体2024年营收', lang: 'zh-CN' } },
  ...
  { server_type: 'analytics_data', tool_name: 'get_financial_data', params: { question: '贵州茅台最新收盘价', lang: 'zh-CN' } },
];
...
const failureRows = failed.length
  ...
  : ['| — | — | 无 |'];
const retried = results.filter(item => item.attempts.length > 1);
const retryObservations = retried.length
  ? retried.map(item => {
      const first = item.attempts[0];
      const code = first.output?.error?.code || 'PROCESS_OR_PARSE_ERROR';
      const outcome = item.passed ? '重试后成功' : '重试后仍失败';
      return `- \`${item.server_type}.${item.tool_name}\` 首次返回 \`${code}\`，${outcome}。`;
    }).join('\n')
  : '- 本轮没有工具触发重试。';
...
- 21 个标准 \`lang\` 工具使用 \`lang: zh-CN\`，验证到后端 \`中文\` 的转换。
- Analytics 使用 \`lang: zh-CN\`，验证到 \`CNS\` 的后端编码转换。
