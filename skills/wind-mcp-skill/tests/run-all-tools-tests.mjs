...
const CASES = [
  ...
  ['stock_data', 'get_stock_quote', { windcode: '600519.SH', begin: D.day, end: D.day, count: -30 }, { windcode: '600519.SH', begin: D.ed, end: D.bd }, 'PARAM_VALIDATION_ERROR'],
  ...
  ['fund_data', 'get_fund_quote', { windcode: '510300.SH', begin: D.day, end: D.day, count: -30 }, { windcode: '510300.SH', begin: D.ed, end: D.bd }, 'PARAM_VALIDATION_ERROR'],
  ...
  ['index_data', 'get_index_quote', { windcode: '000300.SH', begin: D.day, end: D.day, count: -30 }, { windcode: '000300.SH', begin: D.ed, end: D.bd }, 'PARAM_VALIDATION_ERROR'],
