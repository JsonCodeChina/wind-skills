...
const CASES = [
  ...
  ['stock_data', 'get_stock_quote', { windcode: '600519.SH', tradingday: D.day, count: -30 }, { windcode: '600519.SH', count: 'abc' }, 'PARAM_VALIDATION_ERROR'],
  ...
  ['fund_data', 'get_fund_quote', { windcode: '510300.SH', tradingday: D.day, count: -30 }, { windcode: '510300.SH', count: 'abc' }, 'PARAM_VALIDATION_ERROR'],
  ...
  ['index_data', 'get_index_quote', { windcode: '000300.SH', tradingday: D.day, count: -30 }, { windcode: '000300.SH', count: 'abc' }, 'PARAM_VALIDATION_ERROR'],
